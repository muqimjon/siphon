    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Plans",
                columns: new[] { "Id", "DailyRequests", "MaxConcurrent", "MaxFileSizeMb", "Name" },
                values: new object[] { 1, 500, 2, 2048, "Free" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Usage_UserId_TokenId_DateUtc_Endpoint",
                table: "Usage",
                columns: new[] { "UserId", "TokenId", "DateUtc", "Endpoint" },
                unique: true);
        }
